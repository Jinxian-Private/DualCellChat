####################### HBC data
# HBC, all gene PCA
# python train.py --dataset=HBC --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_cora_HBC_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True
# HBC, LR genes
# python train.py --dataset=HBC --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_cora_HBC_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --feature_vector_type=LR
# Ligand genes as u, receptor genes as v , set dimension of s and t the same with input
# python train.py --dataset=HBC --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_cora_HBC_grid_search.json --learning_rate=0.005 --hidden=32 --dimension=200 --validate=True --feature_vector_type=LR
# HBC, all gene PCA, HEAT_digae
# python train.py --dataset=HBC --model=HEAT_digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_cora_HBC_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True

####################### Stereo-seq data
# Stereo-seq, all gene PCA, digae model
# python train.py --dataset=StereoSeq --model=digae --alpha=0.0 --beta=0.2 --epochs=60 --nb_run=5 --logfile=digae_StereoSeq_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True

# Stereo-seq, all gene PCA, HEAT_digae
# python train.py --dataset=StereoSeq --model=HEAT_digae --alpha=0.0 --beta=0.2 --epochs=60 --nb_run=5 --logfile=digae_StereoSeq_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True
...
####################### MERFISH data
# adj_dist
# python train.py --dataset=MERFISH --model=digae --alpha=0.0 --beta=0.2 --epochs=200 --nb_run=5 --logfile=digae_merfish_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True
# adj_LR
# python train.py --dataset=MERFISH --model=digae --alpha=0.0 --beta=0.2 --epochs=200 --nb_run=5 --logfile=digae_merfish_ml_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --task=celltypespecific
...
# noise edges
# python train.py --dataset=MERFISH --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_merfish_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --test_ratio=0.1 --noise=True --noise_disp=2
...
# noise edges
# python train.py --dataset=seqFISH --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_seqFISH_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --test_ratio=0.1 --noise=True --noise_disp=2
...
# noise edges
# python train.py --dataset=HDST_ob --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_HDST_ob_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --test_ratio=0.1 --noise=True --noise_disp=3

# fake edges
# python train.py --dataset=HDST_ob --model=digae --alpha=0.0 --beta=0.2 --epochs=100 --nb_run=5 --logfile=digae_HDST_ob_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --task=fake

# dropout1: delete different ratio genes
# python train.py --dataset=HDST_ob --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_HDST_ob_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --test_ratio=0.1 --dropout_gene=True --dropout_gene_ratio=0.9

# dropout1: transfer different ratio of non-zero value to zero  
# python train.py --dataset=HDST_ob --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_HDST_ob_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --test_ratio=0.1 --dropout_value=True --dropout_value_ratio=0.98
...
# noise edges
# python train.py --dataset=HDST_cancer --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_HDST_cancer_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --test_ratio=0.1 --noise=True --noise_disp=3
