...
#python train.py --dataset=StereoSeq --model=digae --alpha=0.0 --beta=0.2 --epochs=120 --nb_run=5 --logfile=digae_StereoSeq_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True
...
python train.py --dataset=HDST_ob --model=digae --alpha=0.0 --beta=0.2 --epochs=40 --nb_run=5 --logfile=digae_HDST_ob_grid_search.json --learning_rate=0.005 --hidden=64 --dimension=32 --validate=True --test_ratio=0.1 --noise=True --noise_disp=2.1
###### fake edges
